...
begin
    ...
    if Length(ProcName) = 0 then
        ...
        // Note:  If you're getting a compilation error on the following line, you're probably using a Unicode version of Delphi (2009 or newer)
        // To resolve this problem, I recommend that you install the latest version of François Piette's Internet Component Suite
        // and remove the WSocket.pas and HttpProt.pas files included with the source.  You will need to change the reference to HttpProt in the
        // uses clause of UpdateCheck.pas
        // Alternatively, you can simply remove the automatic update check feature from NetTime and bypass the above altogether!
